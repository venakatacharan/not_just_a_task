          ...
          <div className="d-flex flex-row justify-content-between align-items-start bg-light w-100 p-4">
            ...
            <div className="text-end ms-4">
              ...
              <h5 className="fw-bold text-secondary">
                {" "}
                {props.currency} {props.total* props.conversionRate}
              </h5>
            </div>
          </div>
          <div className="p-4">
                  ...
                  return (
                    <tr id={i} key={i}>
                      ...
                      <td className="text-end" style={{ width: "100px" }}>
                        {item.itemPrice * props.conversionRate}&nbsp; {props.currency}
                      </td>
                      <td className="text-end" style={{ width: "100px" }}>
                         {item.itemPrice * item.itemQuantity * props.conversionRate}&nbsp;{props.currency}
                      </td>
                    </tr>
                  );
                })}
            ...
            <Table>
              <tbody>
                ...
                <tr className="text-end">
                  ...
                  <td className="text-end" style={{ width: "100px" }}>
                    {props.info.taxAmount* props.conversionRate}&nbsp; {props.currency}
                  </td>
                </tr>
                {props.discountAmmount !== 0.0 && (
                  <tr className="text-end">
                    ...
                    <td className="text-end" style={{ width: "100px" }}>
                       {props.info.discountAmount* props.conversionRate}&nbsp; {props.currency}
                    </td>
                  </tr>
                )}
                <tr className="text-end">
                  ...
                  <td className="text-end" style={{ width: "100px" }}>
                     {props.info.total* props.conversionRate}&nbsp;{props.currency}
                  </td>
                </tr>
              </tbody>
            </Table>
